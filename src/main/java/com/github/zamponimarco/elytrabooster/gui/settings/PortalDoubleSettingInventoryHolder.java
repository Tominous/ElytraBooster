...
public class PortalDoubleSettingInventoryHolder extends PortalSettingInventoryHolder {
	...
	public PortalDoubleSettingInventoryHolder(ElytraBooster plugin, String key, AbstractPortal portal, HumanEntity player,
			Object value) {
