...
public class PortalIntegerSettingInventoryHolder extends PortalSettingInventoryHolder {
	...
	public PortalIntegerSettingInventoryHolder(ElytraBooster plugin, String key, AbstractPortal portal, HumanEntity player,
			Object value) {
